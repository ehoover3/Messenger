...
import { pusherClient } from "@/src/app/libs/pusher";
...
export default function ConversationList({ initialItems, users }: ConversationListProps) {
  ...
  return (
    <>
      ...
      <aside className={clsx(`fixed inset-y-0 pb-20 lg:pb-0 lg:left-20 lg:w-80 lg:block overflow-y-auto border-r border-gray-200 bg-[#303030]`, isOpen ? "hidden" : "block w-full left-0")}>
        <div className='px-5'>
